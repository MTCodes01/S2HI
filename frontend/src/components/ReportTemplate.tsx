        ...
        <div ref={ref} style={styles.container}>
            ...
            <div style={styles.header}>
                <div style={styles.titleBox}>
                    ...
                    <p style={styles.subtitle}>LEAP Learning Assessment System • Confidential</p>
                </div>
                <div style={{ textAlign: 'right' }}>
                    <div style={{ fontSize: '24px', fontWeight: 900, color: '#3b82f6' }}>LEAP</div>
            ...
            <footer style={styles.footer}>
                ...
                <p style={{ marginTop: '10px' }}>LEAP High-Impact Learning Assessment Systems • Confidential Document • &copy; {new Date().getFullYear()}</p>
            </footer>
        </div>
    );
});
